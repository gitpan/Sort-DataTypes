# This Makefile is for the Sort::DataTypes extension to perl.
#
...
#
#   MakeMaker ARGV: (q[PREFIX=/home/sulbeck/local])
#
#   MakeMaker Parameters:

#     ABSTRACT => q[Sort a list of data using methods relevant to the type of data]
#     AUTHOR => q[Sullivan Beck (sbeck@cpan.org)]
#     NAME => q[Sort::DataTypes]
#     PREREQ_PM => { Date::Manip=>q[0], Carp=>q[0] }
#     VERSION_FROM => q[DataTypes.pm]
...
FULLEXT = Sort/DataTypes
BASEEXT = DataTypes
PARENT_NAME = Sort
DLBASE = $(BASEEXT)
VERSION_FROM = DataTypes.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = DataTypes.pm

PM_TO_BLIB = DataTypes.pm \
	$(INST_LIB)/Sort/DataTypes.pm
...
DISTNAME = Sort-DataTypes
DISTVNAME = Sort-DataTypes-1.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  DataTypes.pm $(INST_MAN3DIR)/Sort::DataTypes.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Sort-DataTypes' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      1.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: DataTypes.pm' >> META_new.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '    Carp:                          0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Date::Manip:                   0' >> META_new.yml
...
disttest : distdir
	cd $(DISTVNAME) && $(ABSPERLRUN) Makefile.PL "PREFIX=/home/sulbeck/local"
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "PREFIX=/home/sulbeck/local"
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Sort a list of data using methods relevant to the type of data</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Sullivan Beck (sbeck@cpan.org)</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  DataTypes.pm $(INST_LIB)/Sort/DataTypes.pm 
